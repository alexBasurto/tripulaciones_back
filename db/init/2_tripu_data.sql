...
--
-- Dumping data for table `tbVotingTags`
--
LOCK TABLES `tbVotingTags` WRITE;

/*!40000 ALTER TABLE `tbVotingTags` DISABLE KEYS */
;

/*!40000 ALTER TABLE `tbVotingTags` ENABLE KEYS */
;
...
-- Dump completed on 2023-12-27 18:11:27